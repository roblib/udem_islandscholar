 ...
 */
?>
<div class="orbit" role="region" aria-label="Landing Page Slideshow" data-orbit data-options="animInFromLeft:fade-in; animInFromRight:fade-in; animOutToLeft:fade-out; animOutToRight:fade-out;" >
<ul class="lp-slideshow orbit-container">
  <?php
    print $content;
  ?>
</ul>
